<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="FuJianList.aspx.cs" Inherits="newsList" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    ID="lblTitle" runat="server" Text=""></asp:Label></a></p>
         <ul class="news-list">
                            ...
                            TypeName="_defaultTableAdapters.显示附件列表TableAdapter">
                <SelectParameters>
            ...
            <ItemTemplate>
             <li><a href="<%#Eval("附件路径") %>"><%#Eval("附件名") %></a></li>
            </ItemTemplate>
            </asp:Repeater>
         </ul> 
